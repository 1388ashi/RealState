<div class="col-md-12">
    <div class="card ">
        ...
        <div class="card-body">
            <form action="{{ route("admin.sellings.index") }}">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="form-group">
                            <label>مبلغ تا :</label>
                            <input type="text" name="amount"   value="{{ number_format(floatval(request('amount', 0))) }}" placeholder="مبلغ مورد نظر را بنویسید" class="form-control comma" />
                        </div>
                    </div>
                </div>
