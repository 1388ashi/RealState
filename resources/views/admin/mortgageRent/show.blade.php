                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row">  
                        ...
                        <ul class="list-group flex-fill">  
                            ...
                            <li class="list-group-item"><b class="bold">پارکینگ: </b>{{ $mortgageRent->parking == 1 ? 'دارد' : 'ندارد' }}</li>  
                            <li class="list-group-item"><b class="bold">انباری: </b>{{ $mortgageRent->warehouse == 1 ? 'دارد' : 'ندارد' }}</li>  
